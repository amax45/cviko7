...
public class WebController {
    ...
    private final static File MP4_FILE = new File("D:\\MDS\\files\\videos\\bbb_1080.mp4");
...
//            model.addAttribute("autoplay", autoplay ? "true" : "");
    ...
    @RequestMapping(value={"/dash/{files}", "/hls/{file}", "/hls/{quality}/{file}"}, method=RequestMethod.GET)
